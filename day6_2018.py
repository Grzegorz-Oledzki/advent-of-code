...
def get_number_of_closest_points(all_distances, all_x_coords, all_y_coords, distances,x_coords, y_coords, distances_index):
    ...
    if min_y not in x_coords_of_the_nearest_points and max_y not in x_coords_of_the_nearest_points and min_x not in \
            y_coords_of_the_nearest_points and max_x not in y_coords_of_the_nearest_points:
        finest_points.append((x_coords[distances_index], y_coords[distances_index]))
    return closest_points, finest_points


def get_all_numbers_of_closest_points(all_distances,x_coords,y_coords, all_x_coords, all_y_coords):
    numbers_of_closest_points = []
    finite_coords = []
    for distances_index in range(len(all_distances)):
        closest_point, finite_coord = get_number_of_closest_points(all_distances,all_x_coords, all_y_coords, all_distances[distances_index],x_coords,y_coords, distances_index)
...
def get_max_finite_coords_numbers_of_closest_points(zipped_coords_with_numbers_of_closest_points, finite_coords):
...
if __name__ == "__main__":
    ...
    all_distances, all_x_coords, all_y_coords = get_distance_to_all_points(x_coords, y_coords)
    all_numbers_of_closest_points, finite_coords = get_all_numbers_of_closest_points(all_distances,x_coords,y_coords, all_x_coords, all_y_coords)
    zipped_coords_with_numbers_of_closest_points = zip_coords_with_numbers_of_closest_points(zip(x_coords, y_coords), all_numbers_of_closest_points)
    print(get_max_finite_coords_numbers_of_closest_points(zipped_coords_with_numbers_of_closest_points, finite_coords))
